...
![img01](assets/markdown-img-paste-20190301183702843.png)
...
* 커뮤니케이션이 간단할 경우
  ...
  ![img02](assets/markdown-img-paste-20190301184122973.png)

* 어려울 경우

  ![img03](assets/markdown-img-paste-20190301184158381.png)
...
* OSI model을 이용한 데이터 교환
  ...
  * De-Capsulation : 데이터에서 헤더를 때면서 상위 레이어로 보냄
    ...
    ![img04](assets/markdown-img-paste-20190301184825208.png)
...
* 라우터를 지나면서(Hop-to-Hop) Mac 주소는 바뀌지만 Logical 주소와 Port 주소는 바뀌지 않음
  ...
  ![img05](assets/markdown-img-paste-20190301191253987.png)
...
* 이더넷을 주로 사용하나, Token ring, Token bus, FDDI, ATM LAN 등도 존재
  ...
  ![img06](assets/markdown-img-paste-20190301192155477.png)
