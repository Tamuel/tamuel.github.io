...
* **Generalized Projection**
  ...
  * {% raw %}$REPORT \leftarrow \rho(SSN, NET\_SALARY, BONUS, TAX)(\Pi_{SSN, SALARY-DEDUCTION, 2000 * YEARS\_SERVICE, 0.25 * SALARY}(EMP))${% end raw %}

* **Aggregate Functions and Grouping**
  * **SUM, COUNT, AVG, MIN, MAX**
    * 값 혹은 튜플 집합에 사용 가능
  * **Grouping**
    * {% raw %}$_{<grouping\ attributes>}\Im_{<function\ list>}(R)${% end raw %}
    * $\Im$ (Script F)
    * eg
      * 모든 사원의 평균 봉급
