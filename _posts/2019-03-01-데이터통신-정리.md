...
![img01](assets/markdown-img-paste-20190301151339509.png)

* Three-layer Protocol
![img02](assets/markdown-img-paste-20190301151417816.png)

* Logical connection between peer layers
![img03](assets/markdown-img-paste-20190301152518318.png)

### TCP/IP Protocol Suite

* Layers in the TCP/IP protocol Suite
![img04](assets/markdown-img-paste-20190301152802671.png)

* Communication through an Internet
![img05](assets/markdown-img-paste-20190301153051471.png)
![img06](assets/markdown-img-paste-20190301153202509.png)
![img07](assets/markdown-img-paste-20190301153231877.png)

#### Encapsulation / Decapsulation

![img08](assets/markdown-img-paste-20190301153331997.png)
...
![img09](assets/markdown-img-paste-20190301165830201.png)
...
![img10](assets/markdown-img-paste-20190301172504515.png)
...
![img11](assets/markdown-img-paste-20190301173014152.png)
...
* 시간 도메인, 진동수 도메인 나눠서 생각 가능
 ![img12](assets/markdown-img-paste-20190301173752751.png)

#### Composite Signals
여러 신호이 합쳐질 수 있음
![img13](assets/markdown-img-paste-20190301173841305.png)
![img14](assets/markdown-img-paste-20190301173848810.png)
...
### Digital Signals
디지털 신호로도 데이터 전송 가능
![img15](assets/markdown-img-paste-20190301174219266.png)
...
![img16](assets/markdown-img-paste-20190301174619544.png)

#### Transmission of Digital Signals
* Basebnad Transmission
  ![img17](assets/markdown-img-paste-20190301174908537.png)

* Bandwidth of two low-pass channels
  * Bandwidth 사이의 주기를 가진 신호만 걸러줌
    ![img18](assets/markdown-img-paste-20190301174939442.png)

### Transmission Impairment (전송 장애)
수신 데이터와 전달 매체를 통해서 전달된 데이터가 다를 수 있음
![img19](assets/markdown-img-paste-20190301175812847.png)

#### Attenuation (신호 감소)
* 신호가 에너지를 잃어서 일어나는 장애
* 중간에 증폭기(Amplifier)를 달아서 해결
  ![img20](assets/markdown-img-paste-20190301175953354.png)

#### Distortion (신호 왜곡)
* 디지털 신호는 서로 다른 주파수를 가진 신호가 결합해서 만들어지는데 이 때 신호들의 속도 차이로 왜곡이 발생
  ![img21](assets/markdown-img-paste-20190301180222984.png)
